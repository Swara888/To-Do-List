...
function CreateToDoItems() {
  if (todoValue.value === "") {
    ...
    const todoItems = `<div title="Hit Double Click and Complete" ondblclick="CompletedToDoItems(this)">${todoValue.value}</div><div>
                    <img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="./edit.png" />
                    <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="./bin.png" /></div></div>`;
...
function ReadToDoItems() {
  todo.forEach((element) => {
    ...
    ${
      style === ""
        ? '<img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="./add.png" />'
        : ""
    }
    <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="./bin.png" /></div></div>`;
    li.innerHTML = todoItems;
